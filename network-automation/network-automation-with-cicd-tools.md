...
![Public Key Authentication](network-automation-with-cicd-tools/Screen\_Shot\_2022-10-31\_at\_10\_59\_26.png)
...
![SSH Crypto Policy Issue](network-automation-with-cicd-tools/Screen\_Shot\_2022-11-03\_at\_16.28.58.png)
...
![Java 11 SDK](network-automation-with-cicd-tools/Screen\_Shot\_2022-11-03\_at\_16\_14\_40-2.png)
...
Then configure the JAVA\_HOME envrionment variable.
...
![Jenkin Config](network-automation-with-cicd-tools/Screen\_Shot\_2022-11-03\_at\_16\_16\_06-2.png)

![Jenkins Config](network-automation-with-cicd-tools/Screen\_Shot\_2022-11-03\_at\_16\_16\_16-2.png)
...
Click on the **New Item** button in the dashboard and choose pipeline as the way we want Jenkins works for us, then we can fill in the pipeline configurations (see the example in _Commands and Pipeline_ section for reference) and run the job, finally we can see the job successfully completed.
